 ...
 */
class getStagiaireRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\StagiaireRepository' shared autowired service.
     *
     * @return \App\Repository\StagiaireRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'StagiaireRepository.php';

        return $container->privates['App\\Repository\\StagiaireRepository'] = new \App\Repository\StagiaireRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
